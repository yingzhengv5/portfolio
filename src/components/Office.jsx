  ...
  return (
    <group {...props} dispose={null}>
      <group name="Scene">
        ...
        <group
          name="RootNode001"
          position={[0.135, 0.005, 1.303]}
          scale={26.569}
        />
        <group name="RootNode002">
          <group
            name="Plane001_Plane001"
            position={[0.003, -0.031, -2.37]}
            rotation={[Math.PI, -1.562, Math.PI]}
            scale={1.356}>
            <mesh
        ...
        <group
          ...
          scale={0.183}>
          <mesh
            name="chair_Cube026-Mesh001"
            geometry={nodes["chair_Cube026-Mesh001"].geometry}
            material={materials["795548.002"]}
          />
          <mesh
            name="chair_Cube026-Mesh001_1"
            geometry={nodes["chair_Cube026-Mesh001_1"].geometry}
            material={materials["DD9944.001"]}
          />
        </group>
        <mesh
          name="group425587018001"
          geometry={nodes.group425587018001.geometry}
          ...
          <group name="group2146178072001">
            <mesh
              name="mesh2146178072001"
              geometry={nodes.mesh2146178072001.geometry}
              material={materials["mat21.003"]}
            />
            <mesh
              name="mesh2146178072001_1"
              geometry={nodes.mesh2146178072001_1.geometry}
              material={materials["mat22.001"]}
            />
            <mesh
              name="mesh2146178072001_2"
              geometry={nodes.mesh2146178072001_2.geometry}
              material={materials["mat16.001"]}
            />
            <mesh
              name="mesh2146178072001_3"
              geometry={nodes.mesh2146178072001_3.geometry}
              material={materials["mat9.003"]}
            />
          </group>
        </mesh>
        <mesh
          name="ComputerMouse_mesh001"
          geometry={nodes.ComputerMouse_mesh001.geometry}
          material={materials["ComputerMouse_mat1.001"]}
          position={[0.856, 1.24, -1.63]}
          rotation={[0, -0.262, 0]}
          scale={0.047}
        />
        <group
          name="Wall_Painting_01_Plane001"
          position={[-0.022, 2.891, -3.007]}
          rotation={[0, -1.571, 0]}
          scale={0.14}>
          <mesh
